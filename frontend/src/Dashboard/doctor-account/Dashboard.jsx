...
2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                  ...
                  <div className="ml-3 ttext-small font-medium">
                    To get approval please complete your profile, We&apos;ll
                    review manually & approve within 3days
                  </div>
                </div>
              )}
              <div className="mt-8">
...
text-[12px] leading-4 lg:text-[16px] lg:leading-6 font-semibold"
                        ...
                        <h3 className="text-[22px] leading-9 font-bold Otext-headingColor mt-3">
                ...
                {tab === "appointments" && <Appointments data={data} />}
