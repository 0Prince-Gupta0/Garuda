              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text_para">
                    ...
                    Porro aspernatur labore doloribus consequuntur voluptate
                    quisquam necessitatibus modi provident dolorem repellat
                    magnam vero.
                  </p>
        ...
        <section>
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
              ...
              <div className="py-[30px] px-5">
                <div className="flex items-center justify-center">
                  <img src={icon02} alt="Find a Doctor Icon" />
                </div>
                <div className="mt-[30px]">
                  <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center">
                    Find a Location
              ...
              <div className="py-[30px] px-5">
                <div className="flex items-center justify-center">
                  <img src={icon03} alt="Find a Doctor Icon" />
                </div>
                <div className="mt-[30px]">
                  <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center">
                    Book Appointment
              ...
              <div className="xl:w-[670px]">
                ...
                <ul className="pl-4">
                  ...
                  <li className="text_para">
                    ...
                    the online scheduling tool to select an appoint time
                  </li>
                </ul>
                <Link to="/">
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                ...
                <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                  <div className="flex items-center justify-between">
                    <div className="flex items-centere gap-[60px] lg:gap-3">
